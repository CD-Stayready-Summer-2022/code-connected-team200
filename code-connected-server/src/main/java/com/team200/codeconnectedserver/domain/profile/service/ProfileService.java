...
public interface ProfileService {
 Profile create(Profile profile) throws ProfileCreationException;
    ...
    @NonNull List<Profiles> getAllFollowers(Long id) throws ProfileNotFoundException;
    @NonNull List<Profiles> getAllFollowing(Long id) throws ProfileNotFoundException;
